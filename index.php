...
<body>
    <header>
        <nav id="logo" class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php"><img src="assets/images/logo.jpg" width="90" heigth="90"></a>
    ...
    <main>
                    ...
                    <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="carousel-caption d-none d-md-block">
                                    <h3>Manutention</h3>
                                    <p>Nos services de manutention</p>
                                </div>
                            </div>
                        </div>
        ...
        <!---------------------  Banner pour liste de voitures  --------------------------------->
        <div class="container mt-5 w-100 ">
            <div class="row align-items-md">
                <div class="col-md-14 p-5">
                    <div class="h-100 p-5 text-white bg-primary border rounded-3" style="background-image: url(assets/images/voiture1.jpg);
                    background-size:cover;
                    background-position:center;  filter:opacity(0.7);">
